...
/**
 * Created by xpbu on 09/03/2017.
 */
public class ExportPMML {
    ...
    public static final String LOCAL_MODEL_PATH = "/Users/xpbu/Documents/Work/repo/maas/maas-service/pmmlData/model0.lr";


    public static void main(String[] args) throws Exception{
        ExportModelProcessor p = new ExportModelProcessor(null, true);
        p.run();
    }

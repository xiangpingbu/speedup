package com.ecreditpal.maas.service.model.minganci.wordcut.viterbi;




import com.ecreditpal.maas.service.model.minganci.wordcut.CharacterUtil;
import com.ecreditpal.maas.service.model.minganci.wordcut.Node;
import com.ecreditpal.maas.service.model.minganci.wordcut.Pair;
...
public class FinalSeg {
    ...
    private static final String PROB_EMIT = "/minganci/fenCiDict/prob_emit.txt";
     ...
     * <p>cut.</p>
     *
     * @param sentence a {@link String} object.
     * @param tokens a {@link List} object.
     */

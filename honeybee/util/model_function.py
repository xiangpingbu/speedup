...
def get_logit_backward(train_woe, test_woe, target, ks_group_num, in_vars=[], withIntercept=True, in_p_value=0.01, in_max_loop=100):
    train_y = train_woe[[target]]
    ...
    train_result = logit_backward(train_x, train_y, vars=woe_var_list, with_intercept=withIntercept, p_value=in_p_value, max_loop=in_max_loop)

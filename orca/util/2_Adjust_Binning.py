...
######################## read data ########################
df0 = pd.read_excel('Model_Dev_Val.xlsx')
...
df1 = pd.DataFrame(df0,columns = {target, 'credit_query_times_three', 'personal_live_join', 'credit_c_utilization'})
df = df1.head(4000)
...
my_var = 'credit_c_utilization'
my_boundary_list =  [0.24981299212598429, 0.59972652468538235, 0.73281381634372367]
[df_train, df_test] = single_numerical(df_train, df_test, my_var, my_target, my_boundary_list)

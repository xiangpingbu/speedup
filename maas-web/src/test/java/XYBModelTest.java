...
//        model.run(map);
    ...
    public void excelHelp() throws Exception {
        ...
        ExcelReaderUtil.readExcel(rowReader, "/Users/lifeng/Desktop/all_data_selected_modify.xlsx");
...
//                List<Double> list = Lists.newArrayList(1000.0, 5100.0);
            map.put("creditLimit", list.get(head.get("credit_total_credit_limit")));//信用卡的总额度
